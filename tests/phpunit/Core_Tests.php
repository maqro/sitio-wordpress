...
class Core_Tests extends Base\TestCase {
	...
	public function test_setup() {
		// Setup
		\WP_Mock::expectActionAdded( 'after_setup_theme',  'TenUp\Maqro\Core\i18n'        );
		\WP_Mock::expectActionAdded( 'wp_head',            'TenUp\Maqro\Core\header_meta' );
		\WP_Mock::expectActionAdded( 'wp_enqueue_scripts', 'TenUp\Maqro\Core\scripts'     );
		\WP_Mock::expectActionAdded( 'wp_enqueue_scripts', 'TenUp\Maqro\Core\styles'      );
	...
	public function test_scripts() {
		...
		\WP_Mock::wpFunction( 'wp_enqueue_script', array(
			...
			'args' => array(
				'wptheme',
				'template_url/assets/js/maqro.min.js',
				array(),
				'0.0.1',
				true,
			),
		...
		\WP_Mock::wpFunction( 'wp_enqueue_script', array(
			...
			'args' => array(
				'wptheme',
				'template_url/assets/js/maqro.js',
				array(),
				'0.0.1',
				true,
			),
